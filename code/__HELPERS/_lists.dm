 ...
 * Несколько примеров работы (при ascending = FALSE):
 * list("a" = 1, "b" = 1, "c" = 50, "d" = 60, "e" = 20, "f" = 100, "g" = 150) Выпадет G с шансом 100%
 * list("a" = 1, "b" = 1, "c" = 50, "d" = 60, "e" = 20, "f" = 100) Выпадет F с шансом 100%
 * list("a" = 1, "b" = 1, "c" = 50, "d" = 60, "e" = 20, "f" = 90, "g" = -1, "k" = 0) Выпадет F с шансом 90%, при этом g и k никогда не смогут выпасть. Если F не выпал, попытается D и т.д.
 *
